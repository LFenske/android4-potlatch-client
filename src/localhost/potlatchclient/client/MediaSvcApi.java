package localhost.potlatchclient.client;
...
public interface MediaSvcApi {
	...
	public Collection<Media> getUsersWhoLikedMedia(@Path("id") long id);

	@GET(MEDIA_SVC_PATH + "/{id}/flaggedby")
	public Collection<Media> getUsersWhoFlaggedMedia(@Path("id") long id);
}
