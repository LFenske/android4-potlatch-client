...
import localhost.potlatchclient.repository.MediaStatus;
 ...
 *      
 * POST /media/{id}/data
 *   - The binary jpg data for the media should be provided in a multipart
 ...
 *     Media. A client MUST *create* a Media first by sending a POST to /media
 *     and getting the identifier for the newly created Media object before
 *     sending a POST to /media/{id}/data. 
 *     
 * GET /media/{id}/data
 *   - Returns the binary jpg data (if any) for the media with the given
 *     identifier. If no jpg data has been uploaded for the specified media,
...
public interface MediaSvcApi {
	...
	@Multipart
	@POST(MEDIA_SVC_PATH + "/{id}/data")
	public MediaStatus setMediaData(@Path("id") long id, @Part("data") TypedFile mediaData);
